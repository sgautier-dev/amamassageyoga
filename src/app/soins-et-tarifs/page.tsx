		...
		items: [
			...
			},
			{
				...
				description: [
					...
					"Peut également être pratiqué avec le Kansa Wand, un outil ayurvédique traditionnel en alliage de cuivre et bois, utilisé pour détendre les traits et raviver naturellement l’éclat du visage.",
				],
				benefitTitle: "Effets",
				benefits: [

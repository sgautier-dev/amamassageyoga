				...
				<Reveal delay="sm">
					<div className="mt-10 rounded-3xl border border-ama-purple/10 bg-white p-8 shadow-sm">
						...
						<div className="mt-8">
							<Link
								href="tel:0610755048"
								className="inline-flex items-center justify-center rounded-full bg-ama-purple px-6 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-ama-pink hover:shadow-md"
							>
								Appeler maintenant
							</Link>
						</div>
